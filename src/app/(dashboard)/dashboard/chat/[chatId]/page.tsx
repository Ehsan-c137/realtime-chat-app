...
export async function generateMetadata({
   ...
   return { title: `Friend | ${chatPartner.name} chat` };
}
...
const page = async ({ params }: PageProps) => {
   ...
   return (
      <div className="flex-1 justify-between flex flex-col h-full max-h-[calc(100vh-1rem)]">
         <div className="flex sm:items-center justify-between pt-16 pb-4 px-2 md:px-0 border-b-2 border-gray-200 shadow-sm">
